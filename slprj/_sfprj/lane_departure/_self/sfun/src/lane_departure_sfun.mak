...
MODEL     = lane_departure
TARGET      = sfun
MODULE_SRCS   = c4_lane_departure.c
MODEL_SRC  = lane_departure_sfun.c
MODEL_REG = lane_departure_sfun_registry.c
MAKEFILE    = lane_departure_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\ChiChaChai\Documents\AMAS-2017\SelfDrivingCar_with_MATLAB\slprj\_sfprj\lane_departure\_self\sfun\src" 
...
OBJLIST_FILE = lane_departure_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
