...
## Generated on : Thu Mar 08 01:06:04 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: ./LaneDetection_rtwlib.lib
...
MODELLIB                  = LaneDetection_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
SHARED_OBJS               =  \
...
PRODUCT = ./LaneDetection_rtwlib.lib
...
DEFINES_ = -DSLMSG_ALLOW_SYSTEM_ALLOC -DMODEL=LaneDetection -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DTERMFCN=0 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
DEFINES_STANDARD = -DMODEL=LaneDetection -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = hough_d_rt.c hough_r_rt.c LaneDetection.c
...
OBJS = hough_d_rt.c.o hough_r_rt.c.o LaneDetection.c.o
