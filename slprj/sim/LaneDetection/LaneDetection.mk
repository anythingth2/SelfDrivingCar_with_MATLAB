...
MODEL                   = LaneDetection
MODULES                 = hough_d_rt.c hough_r_rt.c LaneDetection.c LaneDetection_capi.c LaneDetection_data.c
...
MASTER_ANCHOR_DIR       = 
START_DIR               = C:\Users\ChiChaChai\Documents\AMAS-2017\SelfDrivingCar_with_MATLAB
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
GEN_SAMPLE_MAIN         = 0
TARGET_LANG_EXT         = c
MEX_OPT_FILE            = -f "C:\Program Files\MATLAB\R2017a\bin\win64\mexopts\msvc2013.xml"
COMPUTER                = PCWIN64
...
MODELLIB                  = LaneDetectionlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = LaneDetection_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\vision\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\vision\visionrt\export\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\vision\visionrt\export\include\visionrt
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\simulink\include\sf_runtime
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\sim\LaneDetection
...
LIBS = $(LIBS) $(MATLAB_ROOT)\extern\lib\win64\microsoft\libmwsl_iofile.lib
