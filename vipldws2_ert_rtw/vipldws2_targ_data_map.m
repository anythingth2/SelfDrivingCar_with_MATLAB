  ...
  ;%***********************
    ...
    ;%
	  ...
	  section.data(21).dtTransOffset = 202;
	
	  ;% vipldws2_P.min_safety_Value
	  section.data(22).logicalSrcIdx = 54;
	  section.data(22).dtTransOffset = 522;
  ...
  ;%**************************
    ...
    ;%
	  ...
	  section.data(4).dtTransOffset = 238140;
	  ...
	  section.data(6).dtTransOffset = 698940;
	
	  ;% vipldws2_B.InsertTextLeftLane
	  section.data(7).logicalSrcIdx = 51;
	  section.data(7).dtTransOffset = 929340;
	  ...
	  section.data(14).dtTransOffset = 74;
	  ...
	  section.data(5).dtTransOffset = 768000;
	
	  ;% vipldws2_B.Selector2_g
	  section.data(6).logicalSrcIdx = 185;
	  section.data(6).dtTransOffset = 844800;
  ...
  targMap.checksum0 = 1068353196;
  targMap.checksum1 = 439451649;
  targMap.checksum2 = 2387670265;
  targMap.checksum3 = 765830097;
