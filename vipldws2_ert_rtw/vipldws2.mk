...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/vipldws2.elf
...
MODELREF_LINK_RSPFILE_NAME = vipldws2_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/vipldws2.elf
...
DEFINES_ = -DMODEL=vipldws2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DEXT_MODE=1 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
DEFINES_STANDARD = -DMODEL=vipldws2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
