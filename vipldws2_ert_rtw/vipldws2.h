...
typedef struct {
  ...
  real32_T DrawShapes_l[230400];       /* '<S63>/DrawShapes' */
  real32_T DrawShapes_m[230400];       /* '<S66>/DrawShapes' */
  real32_T InsertText[230400];         /* '<S66>/Insert Text' */
  ...
  int32_T rightC[120];
  int32_T Rs[120];
  real32_T Init[40];                   /* '<S37>/Init' */
  real32_T Assignment[40];             /* '<S38>/Assignment' */
  real32_T fv0[16];
  int32_T mLoc[10];
  int32_T mWidth[10];
  real32_T fv1[8];
  int32_T twoLines_1b[8];
  int32_T HoughLines1[4];              /* '<S27>/Hough Lines1' */
  int32_T Transpose1[4];               /* '<S27>/Transpose1' */
  int32_T tmpOutRC[4];
  int32_T tmpOutRC_m[4];
  real_T Probe[2];                     /* '<S29>/Probe' */
  real_T Selector;                     /* '<S29>/Selector' */
  real32_T ImageDataTypeConversion[230400];/* '<S2>/Image Data Type Conversion' */
  real32_T MatrixConcatenation3[4];    /* '<S29>/Matrix Concatenation3' */
  real32_T UnitDelay2[80];             /* '<S33>/Unit Delay2' */
  real32_T UnitDelay3[320];            /* '<S33>/Unit Delay3' */
  ...
  real32_T Xnew[40];                   /* '<S37>/Reset' */
  real32_T InsertTextRightLane[230400];/* '<S69>/Insert Text: Right Lane' */
  real32_T DrawShapes[230400];         /* '<S68>/DrawShapes' */
  real32_T Selector1[2];               /* '<S38>/Selector1' */
  real32_T Selector2[2];               /* '<S38>/Selector2' */
  real32_T Assignment_i[40];           /* '<S53>/Assignment' */
  real32_T Selector2_f[2];             /* '<S54>/Selector2' */
  real32_T Selector1_k[2];             /* '<S55>/Selector1' */
  real32_T Selector_i[2];              /* '<S41>/Selector' */
  real32_T Selector1_c[4];             /* '<S41>/Selector1' */
  real32_T Selector2_n[16];            /* '<S41>/Selector2' */
  real32_T Assignment_io[320];         /* '<S43>/Assignment' */
  real32_T Assignment_o[80];           /* '<S44>/Assignment' */
  real32_T Assignment_p[40];           /* '<S45>/Assignment' */
  real32_T Assignment_a[40];           /* '<S46>/Assignment' */
  real32_T AX[4];                      /* '<S42>/A*X' */
  real32_T P_prd_Reshape[16];          /* '<S42>/P_prd_Reshape' */
  real32_T Z_est_Multiply[2];          /* '<S42>/Z_est_Multiply' */
  real32_T Z_prd_Multiply[2];          /* '<S42>/Z_prd_Multiply' */
  real32_T uDFIRFilter[48000];         /* '<S3>/2-D FIR Filter' */
  real32_T Saturation[48000];          /* '<S3>/Saturation' */
  real32_T selectrho5[231];            /* '<S31>/select rho5' */
  real32_T Xold[40];                   /* '<S37>/FixPt Unit Delay1' */
  real32_T OverwriteValues[112500];    /* '<S28>/Overwrite Values' */
  real32_T OverwriteValues1[112500];   /* '<S28>/Overwrite Values1' */
  real32_T Selectorrho[2];             /* '<S29>/Selector rho' */
  real32_T Selectortheta[2];           /* '<S29>/Selector theta' */
  real32_T selectrho5_f[20];           /* '<S1>/select rho5' */
  real32_T selectrho2[20];             /* '<S1>/select rho2' */
  real32_T selectrho5_m[756];          /* '<S30>/select rho5' */
  ...
  real32_T Selectorrho_c;              /* '<S31>/Selector rho' */
  real32_T Selectortheta_i;            /* '<S31>/Selector theta' */
  real32_T Selectorrho_o;              /* '<S30>/Selector rho' */
  real32_T Selectortheta_g;            /* '<S30>/Selector theta' */
  real32_T Switch1[2];                 /* '<S38>/Switch1' */
  real32_T Selector2_b[2];             /* '<S53>/Selector2' */
  real32_T Rho_2;                      /* '<S56>/Rho_2' */
  real32_T Switch_m[16];               /* '<S43>/Switch' */
  real32_T Switch_l[4];                /* '<S44>/Switch' */
  real32_T HP_prdt[8];                 /* '<S42>/H*P_prdt' */
  real32_T LDLFactorization[4];        /* '<S47>/LDL Factorization' */
  real32_T y[8];                       /* '<S47>/Forward Substitution' */
  real32_T d[2];                       /* '<S47>/Extract Diagonal' */
  real32_T MatrixScaling[8];           /* '<S47>/Matrix Scaling' */
  real32_T BackwardSubstitution[8];    /* '<S47>/Backward Substitution' */
  real32_T KTrans[8];                  /* '<S42>/K Trans' */
  real32_T Switch2[230400];            /* '<S5>/Switch2' */
  real32_T Add;                        /* '<S14>/Add' */
  real32_T Switch_j[2];                /* '<S46>/Switch' */
  real32_T HP_prdtHtR[4];              /* '<S42>/H*P_prdt*Ht+R' */
  real32_T APAtQ[16];                  /* '<S42>/A*P*At+Q' */
  real32_T X_prdKZHX_prd[4];           /* '<S42>/X_prd+K*(Z-H*X_prd)' */
  real32_T Selector5[3];               /* '<S69>/Selector5' */
  real32_T P_prdKHP_prd[16];           /* '<S42>/P_prd-K*H*P_prd' */
  real32_T ZHX_prd[2];                 /* '<S42>/Z-H*X_prd' */
  real32_T Gain;                       /* '<S56>/Gain' */
  int32_T Init_p[20];                  /* '<S36>/Init' */
  int32_T En_Delay[20];                /* '<S33>/En_Delay' */
  ...
  int32_T Xnew_m[20];                  /* '<S36>/Reset' */
  int32_T out3rdLane[4];               /* '<S5>/Exclude 3rd Lane' */
  int32_T HoughLines[4];               /* '<S27>/Hough Lines' */
  int32_T Transpose_g[4];              /* '<S27>/Transpose' */
  int32_T ForIterator;                 /* '<S38>/For Iterator' */
  int32_T ForIterator_a;               /* '<S53>/For Iterator' */
  int32_T Assignment1[20];             /* '<S53>/Assignment1' */
  int32_T Saturation_h[20];            /* '<S53>/Saturation' */
  int32_T Selector1_b;                 /* '<S53>/Selector1' */
  int32_T ForIterator_l;               /* '<S52>/For Iterator' */
  int32_T Assignment1_m[400];          /* '<S52>/Assignment1' */
  int32_T Assignment2[400];            /* '<S52>/Assignment2' */
  int32_T Add_e[400];                  /* '<S52>/Add' */
  int32_T Assignment_k[40];            /* '<S52>/Assignment' */
  int32_T Assignment3[20];             /* '<S52>/Assignment3' */
  int32_T ForIterator_j;               /* '<S51>/For Iterator' */
  int32_T Selector1_n;                 /* '<S51>/Selector1' */
  int32_T Selector1_i[20];             /* '<S54>/Selector1' */
  int32_T Assignment_p2[400];          /* '<S54>/Assignment' */
  int32_T ForIterator_f;               /* '<S55>/For Iterator' */
  int32_T Assignment_j[20];            /* '<S55>/Assignment' */
  int32_T Add7;                        /* '<S56>/Add7' */
  int32_T Iterator;                    /* '<S40>/Iterator' */
  int32_T En_Selector;                 /* '<S40>/En_Selector' */
  int32_T ForIterator_e;               /* '<S32>/For Iterator' */
  ...
  int32_T Xold_g[20];                  /* '<S36>/FixPt Unit Delay1' */
  ...
  int32_T Selector2_m[8];              /* '<S66>/Selector2' */
  int32_T Transpose1_p[8];             /* '<S66>/Transpose1' */
  ...
  int32_T Selector1_ce[4];             /* '<S27>/Selector1' */
  int32_T Selector2_l[4];              /* '<S27>/Selector2' */
  ...
  int32_T idxBLin_p[2];
  int32_T hIdxA_c[2];
  int32_T Minimum_o1;                  /* '<S52>/Minimum' */
  int32_T DataTypeConversion3[2];      /* '<S52>/Data Type  Conversion3' */
  int32_T Switch1_l;                   /* '<S55>/Switch1' */
  int32_T Rst_Selector;                /* '<S40>/Rst_Selector' */
  int32_T Selector_n;                  /* '<S53>/Selector' */
  int32_T Switch1_bi[400];             /* '<S52>/Switch1' */
  int32_T Abs1;                        /* '<S56>/Abs1' */
  ...
  int32_T qY;
  int32_T qY_g;
  uint32_T Minimum;                    /* '<S53>/Minimum' */
  uint32_T Switch3;                    /* '<S53>/Switch3' */
  uint32_T Minimum_o2[2];              /* '<S52>/Minimum' */
  uint32_T fromIdx;
  uint32_T toIdx;
  ZCEventType zcEvent;
  uint16_T FindLocalMaxima1_o1[2];     /* '<S31>/Find Local Maxima1' */
  uint16_T FindLocalMaxima1_o2;        /* '<S31>/Find Local Maxima1' */
  uint16_T FindLocalMaxima1_o1_f[2];   /* '<S30>/Find Local Maxima1' */
  uint16_T FindLocalMaxima1_o2_c;      /* '<S30>/Find Local Maxima1' */
  uint16_T FindLocalMaxima[4];         /* '<S29>/Find Local Maxima' */
  uint16_T Selector1_m[4];             /* '<S29>/Selector1' */
  uint16_T Transpose_m[4];             /* '<S29>/Transpose' */
  uint16_T Selector2_mw[2];            /* '<S31>/Selector2' */
  uint16_T Transpose_b[2];             /* '<S31>/Transpose' */
  uint16_T Selector1_e[2];             /* '<S30>/Selector1' */
  uint16_T Transpose_gb[2];            /* '<S30>/Transpose' */
  uint16_T selectrho3[2];              /* '<S29>/select rho3' */
  uint16_T Bias3_f;                    /* '<S31>/Bias3' */
  uint16_T Bias3_d;                    /* '<S30>/Bias3' */
  ...
  int8_T Bias1_j[2];                   /* '<S66>/Bias1' */
  int8_T Bias_h;                       /* '<S66>/Bias' */
  uint8_T MatrixConcatenate[230400];   /* '<S26>/Matrix Concatenate' */
  uint8_T Selector_g[76800];           /* '<S67>/Selector' */
  uint8_T Selector1_l[76800];          /* '<S67>/Selector1' */
  uint8_T Selector2_g[76800];          /* '<S67>/Selector2' */
  uint8_T Rotate[230400];              /* '<S2>/Rotate' */
  uint8_T ImageDataTypeConversion_p[230400];/* '<S5>/Image Data Type Conversion' */
  uint8_T FixPtLogicalOperator;        /* '<S36>/FixPt Logical Operator' */
  uint8_T FixPtUnitDelay2;             /* '<S36>/FixPt Unit Delay2' */
  ...
  boolean_T Compare_m[20];             /* '<S35>/Compare' */
  boolean_T Assignment2_m[20];         /* '<S53>/Assignment2' */
  boolean_T Selector2_fh;              /* '<S55>/Selector2' */
  boolean_T Rst_And;                   /* '<S40>/Rst_And' */
  boolean_T En_Or;                     /* '<S40>/En_Or' */
  boolean_T Assignment_d[2];           /* '<S32>/Assignment' */
  boolean_T In;                        /* '<S15>/In' */
  ...
  boolean_T Selector_b;                /* '<S38>/Selector' */
  boolean_T Compare_p[20];             /* '<S60>/Compare' */
  boolean_T Compare_mb;                /* '<S57>/Compare' */
  boolean_T En_Not;                    /* '<S40>/En_Not' */
  ...
  boolean_T Compare_n;                 /* '<S59>/Compare' */
  boolean_T Switch1_m[20];             /* '<S53>/Switch1' */
  ...
  boolean_T Compare_ni;                /* '<S61>/Compare' */
} B_vipldws2_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  codertarget_linux_blocks_SDLV_T obj; /* '<S65>/MATLAB System' */
  void *MatrixConcatenation3_PWORK;    /* '<S29>/Matrix Concatenation3' */
  struct {
    void *LoggedData;
  ...
  void *MATLABSystem_PWORK;            /* '<S65>/MATLAB System' */
  real32_T FixPtUnitDelay1_DSTATE[40]; /* '<S37>/FixPt Unit Delay1' */
  real32_T UnitDelay2_DSTATE[80];      /* '<S33>/Unit Delay2' */
  real32_T UnitDelay3_DSTATE[320];     /* '<S33>/Unit Delay3' */
  int32_T FixPtUnitDelay1_DSTATE_d[20];/* '<S36>/FixPt Unit Delay1' */
  int32_T En_Delay_DSTATE[20];         /* '<S33>/En_Delay' */
  int32_T Delay1_DSTATE[400];          /* '<S52>/Delay1' */
  ...
  real32_T FindLocalMaxima1_TEMP_IN_DWORKS[231];/* '<S31>/Find Local Maxima1' */
  real32_T FindLocalMaxima_TEMP_IN_DWORKS[112500];/* '<S29>/Find Local Maxima' */
  real32_T FindLocalMaxima1_TEMP_IN_DWOR_e[756];/* '<S30>/Find Local Maxima1' */
  real32_T ColorSpaceConversion1_DWORK1[86400];/* '<S2>/Color Space  Conversion1' */
  real32_T InsertText_colorVectorDW[3];/* '<S66>/Insert Text' */
  ...
  real32_T Add1_DWORK1;                /* '<S56>/Add1' */
  real32_T LDLFactorization_VMX[2];    /* '<S47>/LDL Factorization' */
  ...
  int32_T FindLocalMaxima_DIMS1[2];    /* '<S29>/Find Local Maxima' */
  int32_T Selector1_DIMS1[2];          /* '<S29>/Selector1' */
  int32_T Transpose_DIMS1[2];          /* '<S29>/Transpose' */
  int32_T selectrho_DIMS1[2];          /* '<S29>/select rho' */
  int32_T Selectorrho_DIMS1[2];        /* '<S29>/Selector rho' */
  int32_T selectrho3_DIMS1[2];         /* '<S29>/select rho3' */
  int32_T Selectortheta_DIMS1[2];      /* '<S29>/Selector theta' */
  int32_T MatrixConcatenation3_DIMS1[2];/* '<S29>/Matrix Concatenation3' */
  int32_T DrawShapes_DW_Polygon[72];   /* '<S66>/DrawShapes' */
  int32_T DrawShapes_DW_Points[16];    /* '<S66>/DrawShapes' */
  int32_T InsertText_TxtLoc[2];        /* '<S66>/Insert Text' */
  ...
  int32_T Selector2_DIMS1[2];          /* '<S53>/Selector2' */
  int32_T Selector1_DIMS1_l[2];        /* '<S55>/Selector1' */
  uint32_T FindLocalMaxima_NUMPEAKS_DWORK;/* '<S29>/Find Local Maxima' */
  uint32_T NSampleEnable_Counter;      /* '<S5>/N-Sample Enable' */
  uint32_T InsertText_TxtSelctn;       /* '<S66>/Insert Text' */
  ...
  uint8_T FixPtUnitDelay2_DSTATE;      /* '<S37>/FixPt Unit Delay2' */
  uint8_T FixPtUnitDelay2_DSTATE_b;    /* '<S36>/FixPt Unit Delay2' */
  boolean_T Delay1_DSTATE_g[20];       /* '<S53>/Delay1' */
  boolean_T Minimum_Valdata;           /* '<S53>/Minimum' */
  int8_T Enablesignalgenerator_SubsysRan;/* '<S29>/Enable signal generator' */
  ...
  int8_T DrawPolygon_SubsysRanBC;      /* '<S66>/Draw  Polygon' */
  int8_T Selectalinefromtherepositoryifi;/* '<S51>/Select a line from the repository; if it is valid (Count > 0),  Calculate its distance to the input lines.' */
  int8_T Differencebetweentwolines_Subsy;/* '<S55>/Difference between  two lines' */
  int8_T Options_SubsysRanBC;          /* '<S40>/Options' */
  int8_T Core_SubsysRanBC;             /* '<S41>/Core' */
  uint8_T DrawShapes_DW_PixCount[320]; /* '<S66>/DrawShapes' */
  uint8_T InsertText_RepBuf;           /* '<S66>/Insert Text' */
  uint8_T InsertText_VarHolder;        /* '<S66>/Insert Text' */
  uint8_T InsertText_StringDataDW[74]; /* '<S66>/Insert Text' */
  ...
  uint8_T ForIterator_IterationMarker; /* '<S51>/For Iterator' */
  uint8_T ForIterator_IterationMarker_c;/* '<S55>/For Iterator' */
  uint8_T Iterator_IterationMarker[4]; /* '<S40>/Iterator' */
  boolean_T uDFIRFilter_isHgtUpd[2];   /* '<S3>/2-D FIR Filter' */
  boolean_T objisempty;                /* '<S65>/MATLAB System' */
  boolean_T LDLFactorization_STATE;    /* '<S47>/LDL Factorization' */
} DW_vipldws2_T;
 ...
 * Block '<S39>/Check Signal Attributes' : Unused code path elimination
 ...
 * Block '<S29>/Zero-Order Hold1' : Eliminated since input and output rates are identical
 * Block '<S29>/Zero-Order Hold2' : Eliminated since input and output rates are identical
 * Block '<S42>/P_Reshape' : Reshape block reduction
 ...
 * '<S26>'  : 'vipldws2/Input/RGB to Image'
 * '<S27>'  : 'vipldws2/Lane Detection/3rd lane: Right-Left'
 * '<S28>'  : 'vipldws2/Lane Detection/Overwrite'
 * '<S29>'  : 'vipldws2/Lane Detection/Peak detection'
 * '<S30>'  : 'vipldws2/Lane Detection/3rd lane: Right-Left/Find Left 3rd Lane'
 * '<S31>'  : 'vipldws2/Lane Detection/3rd lane: Right-Left/Find Right 3rd Lane'
 * '<S32>'  : 'vipldws2/Lane Detection/Peak detection/Enable signal generator'
 * '<S33>'  : 'vipldws2/Lane Tracking/Kalman Filter'
 * '<S34>'  : 'vipldws2/Lane Tracking/Matching'
 * '<S35>'  : 'vipldws2/Lane Tracking/Only update the lines which  Kalman filter has been  trained for enough time'
 * '<S36>'  : 'vipldws2/Lane Tracking/Unit Delay Resettable'
 * '<S37>'  : 'vipldws2/Lane Tracking/Unit Delay Resettable1'
 * '<S38>'  : 'vipldws2/Lane Tracking/Update'
 * '<S39>'  : 'vipldws2/Lane Tracking/Kalman Filter/Check Signal Attributes'
 * '<S40>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control'
 * '<S41>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options'
 * '<S42>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Core'
 * '<S43>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/P_prd_Assign'
 * '<S44>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/X_prd_Assign'
 * '<S45>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Z_est_Assign'
 * '<S46>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Z_prd_Assign'
 * '<S47>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Core/LDL Solver'
 * '<S48>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Core/LDL Solver/Check Signal Attributes'
 * '<S49>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Core/LDL Solver/Check Signal Attributes1'
 * '<S50>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Core/LDL Solver/Check Signal Attributes2'
 * '<S51>'  : 'vipldws2/Lane Tracking/Matching/Calculate the distances between  the lines found in the current  frame and those in the repository'
 * '<S52>'  : 'vipldws2/Lane Tracking/Matching/Find the best  matches between the current  lines and those in the repository'
 * '<S53>'  : 'vipldws2/Lane Tracking/Matching/Update the repository'
 * '<S54>'  : 'vipldws2/Lane Tracking/Matching/Calculate the distances between  the lines found in the current  frame and those in the repository/Select a line from the repository; if it is valid (Count > 0),  Calculate its distance to the input lines.'
 * '<S55>'  : 'vipldws2/Lane Tracking/Matching/Calculate the distances between  the lines found in the current  frame and those in the repository/Select a line from the repository; if it is valid (Count > 0),  Calculate its distance to the input lines./Calculate the distances between  the chosen line in the repository  and all input lines.'
 ...
 * '<S57>'  : 'vipldws2/Lane Tracking/Matching/Find the best  matches between the current  lines and those in the repository/Compare To Constant'
 * '<S58>'  : 'vipldws2/Lane Tracking/Matching/Update the repository/Compare To Constant'
 * '<S59>'  : 'vipldws2/Lane Tracking/Matching/Update the repository/Compare To Constant1'
 * '<S60>'  : 'vipldws2/Lane Tracking/Matching/Update the repository/Compare To Zero'
 * '<S61>'  : 'vipldws2/Output/Compare To Constant1'
 * '<S62>'  : 'vipldws2/Output/Compare To Constant2'
 * '<S63>'  : 'vipldws2/Output/Draw  3rd Line'
 * '<S64>'  : 'vipldws2/Output/Exclude 3rd Lane'
 * '<S65>'  : 'vipldws2/Output/SDL Video Display'
 * '<S66>'  : 'vipldws2/Output/Subsystem'
 * '<S67>'  : 'vipldws2/Output/Subsystem1'
