...
typedef struct {
  ...
  real32_T DrawShapes_l[230400];       /* '<S64>/DrawShapes' */
  real32_T DrawShapes_m[230400];       /* '<S67>/DrawShapes' */
  real32_T InsertText[230400];         /* '<S67>/Insert Text' */
  real32_T InsertTextLeftLane[230400]; /* '<S70>/Insert Text: Left Lane' */
  uint8_T pln1[76800];
  uint8_T pln2[76800];
  uint8_T pln3[76800];
  ...
  int32_T rightC[120];
  int32_T Rs[120];
  real32_T Init[40];                   /* '<S38>/Init' */
  real32_T Assignment[40];             /* '<S39>/Assignment' */
  real32_T fv0[16];
  int32_T mLoc[10];
  int32_T mWidth[10];
  real32_T KTrans[8];                  /* '<S43>/K Trans' */
  real32_T Switch2[230400];            /* '<S5>/Switch2' */
  real32_T fv1[8];
  int32_T twoLines_1b[8];
  int32_T HoughLines[4];               /* '<S28>/Hough Lines' */
  int32_T Transpose_g[4];              /* '<S28>/Transpose' */
  int32_T HoughLines1[4];              /* '<S28>/Hough Lines1' */
  int32_T Transpose1[4];               /* '<S28>/Transpose1' */
  int32_T tmpOutRC[4];
  int32_T tmpOutRC_m[4];
  real_T Probe[2];                     /* '<S30>/Probe' */
  real_T Selector;                     /* '<S30>/Selector' */
  real32_T ImageDataTypeConversion[230400];/* '<S2>/Image Data Type Conversion' */
  real32_T MatrixConcatenation3[4];    /* '<S30>/Matrix Concatenation3' */
  real32_T UnitDelay2[80];             /* '<S34>/Unit Delay2' */
  real32_T UnitDelay3[320];            /* '<S34>/Unit Delay3' */
  ...
  real32_T Xnew[40];                   /* '<S38>/Reset' */
  real32_T InsertTextRightLane[230400];/* '<S70>/Insert Text: Right Lane' */
  real32_T DrawShapes[230400];         /* '<S69>/DrawShapes' */
  real32_T Selector1[2];               /* '<S39>/Selector1' */
  real32_T Selector2[2];               /* '<S39>/Selector2' */
  real32_T Assignment_i[40];           /* '<S54>/Assignment' */
  real32_T Selector2_f[2];             /* '<S55>/Selector2' */
  real32_T Selector1_k[2];             /* '<S56>/Selector1' */
  real32_T Selector_i[2];              /* '<S42>/Selector' */
  real32_T Selector1_c[4];             /* '<S42>/Selector1' */
  real32_T Selector2_n[16];            /* '<S42>/Selector2' */
  real32_T Assignment_io[320];         /* '<S44>/Assignment' */
  real32_T Assignment_o[80];           /* '<S45>/Assignment' */
  real32_T Assignment_p[40];           /* '<S46>/Assignment' */
  real32_T Assignment_a[40];           /* '<S47>/Assignment' */
  real32_T AX[4];                      /* '<S43>/A*X' */
  real32_T P_prd_Reshape[16];          /* '<S43>/P_prd_Reshape' */
  real32_T Z_est_Multiply[2];          /* '<S43>/Z_est_Multiply' */
  real32_T Z_prd_Multiply[2];          /* '<S43>/Z_prd_Multiply' */
  real32_T uDFIRFilter[38400];         /* '<S3>/2-D FIR Filter' */
  real32_T Saturation[38400];          /* '<S3>/Saturation' */
  real32_T selectrho5[231];            /* '<S32>/select rho5' */
  real32_T Xold[40];                   /* '<S38>/FixPt Unit Delay1' */
  real32_T OverwriteValues[122940];    /* '<S29>/Overwrite Values' */
  real32_T OverwriteValues1[122940];   /* '<S29>/Overwrite Values1' */
  real32_T Selectorrho[2];             /* '<S30>/Selector rho' */
  real32_T Selectortheta[2];           /* '<S30>/Selector theta' */
  real32_T selectrho5_f[20];           /* '<S1>/select rho5' */
  real32_T selectrho2[20];             /* '<S1>/select rho2' */
  real32_T selectrho5_m[756];          /* '<S31>/select rho5' */
  ...
  real32_T Selectorrho_c;              /* '<S32>/Selector rho' */
  real32_T Selectortheta_i;            /* '<S32>/Selector theta' */
  real32_T Selectorrho_o;              /* '<S31>/Selector rho' */
  real32_T Selectortheta_g;            /* '<S31>/Selector theta' */
  real32_T Switch1[2];                 /* '<S39>/Switch1' */
  real32_T Selector2_b[2];             /* '<S54>/Selector2' */
  real32_T Rho_2;                      /* '<S57>/Rho_2' */
  real32_T Switch_m[16];               /* '<S44>/Switch' */
  real32_T Switch_l[4];                /* '<S45>/Switch' */
  real32_T HP_prdt[8];                 /* '<S43>/H*P_prdt' */
  real32_T LDLFactorization[4];        /* '<S48>/LDL Factorization' */
  real32_T y[8];                       /* '<S48>/Forward Substitution' */
  real32_T d[2];                       /* '<S48>/Extract Diagonal' */
  real32_T MatrixScaling[8];           /* '<S48>/Matrix Scaling' */
  real32_T BackwardSubstitution[8];    /* '<S48>/Backward Substitution' */
  real32_T Add;                        /* '<S14>/Add' */
  real32_T Switch_j[2];                /* '<S47>/Switch' */
  real32_T HP_prdtHtR[4];              /* '<S43>/H*P_prdt*Ht+R' */
  real32_T APAtQ[16];                  /* '<S43>/A*P*At+Q' */
  real32_T X_prdKZHX_prd[4];           /* '<S43>/X_prd+K*(Z-H*X_prd)' */
  real32_T Selector5[3];               /* '<S70>/Selector5' */
  real32_T P_prdKHP_prd[16];           /* '<S43>/P_prd-K*H*P_prd' */
  real32_T ZHX_prd[2];                 /* '<S43>/Z-H*X_prd' */
  real32_T Gain;                       /* '<S57>/Gain' */
  int32_T Init_p[20];                  /* '<S37>/Init' */
  int32_T En_Delay[20];                /* '<S34>/En_Delay' */
  ...
  int32_T Xnew_m[20];                  /* '<S37>/Reset' */
  int32_T out3rdLane[4];               /* '<S5>/Exclude 3rd Lane' */
  int32_T ForIterator;                 /* '<S39>/For Iterator' */
  int32_T ForIterator_a;               /* '<S54>/For Iterator' */
  int32_T Assignment1[20];             /* '<S54>/Assignment1' */
  int32_T Saturation_h[20];            /* '<S54>/Saturation' */
  int32_T Selector1_b;                 /* '<S54>/Selector1' */
  int32_T ForIterator_l;               /* '<S53>/For Iterator' */
  int32_T Assignment1_m[400];          /* '<S53>/Assignment1' */
  int32_T Assignment2[400];            /* '<S53>/Assignment2' */
  int32_T Add_e[400];                  /* '<S53>/Add' */
  int32_T Assignment_k[40];            /* '<S53>/Assignment' */
  int32_T Assignment3[20];             /* '<S53>/Assignment3' */
  int32_T ForIterator_j;               /* '<S52>/For Iterator' */
  int32_T Selector1_n;                 /* '<S52>/Selector1' */
  int32_T Selector1_i[20];             /* '<S55>/Selector1' */
  int32_T Assignment_p2[400];          /* '<S55>/Assignment' */
  int32_T ForIterator_f;               /* '<S56>/For Iterator' */
  int32_T Assignment_j[20];            /* '<S56>/Assignment' */
  int32_T Add7;                        /* '<S57>/Add7' */
  int32_T Iterator;                    /* '<S41>/Iterator' */
  int32_T En_Selector;                 /* '<S41>/En_Selector' */
  int32_T ForIterator_e;               /* '<S33>/For Iterator' */
  ...
  int32_T Xold_g[20];                  /* '<S37>/FixPt Unit Delay1' */
  ...
  int32_T MatrixConcatenation6[12];    /* '<S72>/Matrix Concatenation6' */
  int32_T Selector2_h[12];             /* '<S69>/Selector2' */
  int32_T Transpose1_b[12];            /* '<S69>/Transpose1' */
  int32_T TmpSignalConversionAtDrawShapes[4];
  int32_T Selector1_ce[4];             /* '<S28>/Selector1' */
  int32_T Selector2_l[4];              /* '<S28>/Selector2' */
  ...
  int32_T idxB_c[2];
  int32_T idxALin[2];
  int32_T Minimum_o1;                  /* '<S53>/Minimum' */
  int32_T DataTypeConversion3[2];      /* '<S53>/Data Type  Conversion3' */
  int32_T Switch1_l;                   /* '<S56>/Switch1' */
  int32_T Rst_Selector;                /* '<S41>/Rst_Selector' */
  int32_T Selector_n;                  /* '<S54>/Selector' */
  int32_T Switch1_bi[400];             /* '<S53>/Switch1' */
  int32_T Abs1;                        /* '<S57>/Abs1' */
  ...
  int32_T Add_j[20];                   /* '<S54>/Add' */
  int32_T Selector7[2];                /* '<S70>/Selector7' */
  int32_T Intersectionwithbottomimagebo_j;/* '<S24>/Intersection with  bottom image boundary1' */
  int32_T Bias2[2];                    /* '<S70>/Bias2' */
  int32_T Transpose2[2];               /* '<S70>/Transpose2' */
  int32_T col;
  int32_T j;
  int32_T C2;
  int32_T r1;
  ...
  int32_T qY;
  int32_T qY_g;
  uint32_T Minimum;                    /* '<S54>/Minimum' */
  uint32_T Switch3;                    /* '<S54>/Switch3' */
  uint32_T Minimum_o2[2];              /* '<S53>/Minimum' */
  uint32_T fromIdx;
  uint32_T toIdx;
  ZCEventType zcEvent;
  uint16_T FindLocalMaxima1_o1[2];     /* '<S32>/Find Local Maxima1' */
  uint16_T FindLocalMaxima1_o2;        /* '<S32>/Find Local Maxima1' */
  uint16_T FindLocalMaxima1_o1_f[2];   /* '<S31>/Find Local Maxima1' */
  uint16_T FindLocalMaxima1_o2_c;      /* '<S31>/Find Local Maxima1' */
  uint16_T FindLocalMaxima[4];         /* '<S30>/Find Local Maxima' */
  uint16_T Selector1_m[4];             /* '<S30>/Selector1' */
  uint16_T Transpose_m[4];             /* '<S30>/Transpose' */
  uint16_T Selector2_mw[2];            /* '<S32>/Selector2' */
  uint16_T Transpose_b[2];             /* '<S32>/Transpose' */
  uint16_T Selector1_e[2];             /* '<S31>/Selector1' */
  uint16_T Transpose_gb[2];            /* '<S31>/Transpose' */
  uint16_T selectrho3[2];              /* '<S30>/select rho3' */
  uint16_T Bias3_f;                    /* '<S32>/Bias3' */
  uint16_T Bias3_d;                    /* '<S31>/Bias3' */
  ...
  uint8_T MatrixConcatenate[230400];   /* '<S27>/Matrix Concatenate' */
  uint8_T Rotate[230400];              /* '<S2>/Rotate' */
  uint8_T ImageDataTypeConversion_p[230400];/* '<S5>/Image Data Type Conversion' */
  uint8_T Selector_g[76800];           /* '<S68>/Selector' */
  uint8_T Selector1_l[76800];          /* '<S68>/Selector1' */
  uint8_T Selector2_g[76800];          /* '<S68>/Selector2' */
  uint8_T y_g[230400];                 /* '<S2>/MATLAB Function1' */
  uint8_T Rotate_g[230400];            /* '<S5>/Rotate' */
  uint8_T FixPtLogicalOperator;        /* '<S37>/FixPt Logical Operator' */
  uint8_T FixPtUnitDelay2;             /* '<S37>/FixPt Unit Delay2' */
  ...
  boolean_T Compare_m[20];             /* '<S36>/Compare' */
  boolean_T Assignment2_m[20];         /* '<S54>/Assignment2' */
  boolean_T Selector2_fh;              /* '<S56>/Selector2' */
  boolean_T Rst_And;                   /* '<S41>/Rst_And' */
  boolean_T En_Or;                     /* '<S41>/En_Or' */
  boolean_T Assignment_d[2];           /* '<S33>/Assignment' */
  boolean_T In;                        /* '<S15>/In' */
  ...
  boolean_T Selector_b;                /* '<S39>/Selector' */
  boolean_T Compare_p[20];             /* '<S61>/Compare' */
  boolean_T Compare_mb;                /* '<S58>/Compare' */
  boolean_T En_Not;                    /* '<S41>/En_Not' */
  ...
  boolean_T Switch1_m[20];             /* '<S54>/Switch1' */
  ...
  boolean_T Compare_ni;                /* '<S62>/Compare' */
} B_vipldws2_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  codertarget_linux_blocks_SDLV_T obj; /* '<S66>/MATLAB System' */
  void *MatrixConcatenation3_PWORK;    /* '<S30>/Matrix Concatenation3' */
  struct {
    void *LoggedData;
  ...
  struct {
    ...
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWorkspace_PWORK;               /* '<S71>/From Workspace' */

  void *MATLABSystem_PWORK;            /* '<S66>/MATLAB System' */
  real32_T FixPtUnitDelay1_DSTATE[40]; /* '<S38>/FixPt Unit Delay1' */
  real32_T UnitDelay2_DSTATE[80];      /* '<S34>/Unit Delay2' */
  real32_T UnitDelay3_DSTATE[320];     /* '<S34>/Unit Delay3' */
  int32_T FixPtUnitDelay1_DSTATE_d[20];/* '<S37>/FixPt Unit Delay1' */
  int32_T En_Delay_DSTATE[20];         /* '<S34>/En_Delay' */
  int32_T Delay1_DSTATE[400];          /* '<S53>/Delay1' */
  ...
  real32_T FindLocalMaxima1_TEMP_IN_DWORKS[231];/* '<S32>/Find Local Maxima1' */
  real32_T FindLocalMaxima_TEMP_IN_DWORKS[122940];/* '<S30>/Find Local Maxima' */
  real32_T FindLocalMaxima1_TEMP_IN_DWOR_e[756];/* '<S31>/Find Local Maxima1' */
  ...
  real32_T InsertTextLeftLane_colorVectorD[3];/* '<S70>/Insert Text: Left Lane' */
  real32_T InsertTextRightLane_colorVector[3];/* '<S70>/Insert Text: Right Lane' */
  real32_T DrawShapes_DW_FillColorAdd[3];/* '<S69>/DrawShapes' */
  real32_T DrawShapes_DW_OneMOpacity;  /* '<S69>/DrawShapes' */
  real32_T Add1_DWORK1;                /* '<S57>/Add1' */
  real32_T LDLFactorization_VMX[2];    /* '<S48>/LDL Factorization' */
  ...
  int32_T FindLocalMaxima_DIMS1[2];    /* '<S30>/Find Local Maxima' */
  int32_T Selector1_DIMS1[2];          /* '<S30>/Selector1' */
  int32_T Transpose_DIMS1[2];          /* '<S30>/Transpose' */
  int32_T selectrho_DIMS1[2];          /* '<S30>/select rho' */
  int32_T Selectorrho_DIMS1[2];        /* '<S30>/Selector rho' */
  int32_T selectrho3_DIMS1[2];         /* '<S30>/select rho3' */
  int32_T Selectortheta_DIMS1[2];      /* '<S30>/Selector theta' */
  int32_T MatrixConcatenation3_DIMS1[2];/* '<S30>/Matrix Concatenation3' */
  ...
  int32_T InsertTextLeftLane_TxtLoc[2];/* '<S70>/Insert Text: Left Lane' */
  int32_T InsertTextRightLane_TxtLoc[2];/* '<S70>/Insert Text: Right Lane' */
  int32_T Selector2_DIMS1[2];          /* '<S54>/Selector2' */
  int32_T Selector1_DIMS1_l[2];        /* '<S56>/Selector1' */
  uint32_T FindLocalMaxima_NUMPEAKS_DWORK;/* '<S30>/Find Local Maxima' */
  uint32_T NSampleEnable_Counter;      /* '<S5>/N-Sample Enable' */
  uint32_T InsertText_TxtSelctn;       /* '<S67>/Insert Text' */
  uint32_T InsertTextLeftLane_TxtSelctn;/* '<S70>/Insert Text: Left Lane' */
  uint32_T InsertTextRightLane_TxtSelctn;/* '<S70>/Insert Text: Right Lane' */
  struct {
    int_T PrevIndex;
  } FromWorkspace_IWORK;               /* '<S71>/From Workspace' */

  uint16_T Counter_Count;              /* '<S17>/Counter' */
  int8_T Delay_DSTATE;                 /* '<S17>/Delay' */
  int8_T Delay1_DSTATE_e;              /* '<S17>/Delay1' */
  uint8_T FixPtUnitDelay2_DSTATE;      /* '<S38>/FixPt Unit Delay2' */
  uint8_T FixPtUnitDelay2_DSTATE_b;    /* '<S37>/FixPt Unit Delay2' */
  boolean_T Delay1_DSTATE_g[20];       /* '<S54>/Delay1' */
  boolean_T Minimum_Valdata;           /* '<S54>/Minimum' */
  int8_T Enablesignalgenerator_SubsysRan;/* '<S30>/Enable signal generator' */
  ...
  int8_T Selectalinefromtherepositoryifi;/* '<S52>/Select a line from the repository; if it is valid (Count > 0),  Calculate its distance to the input lines.' */
  int8_T Differencebetweentwolines_Subsy;/* '<S56>/Difference between  two lines' */
  int8_T Options_SubsysRanBC;          /* '<S41>/Options' */
  int8_T Core_SubsysRanBC;             /* '<S42>/Core' */
  ...
  uint8_T InsertTextLeftLane_RepBuf;   /* '<S70>/Insert Text: Left Lane' */
  uint8_T InsertTextLeftLane_VarHolder;/* '<S70>/Insert Text: Left Lane' */
  uint8_T InsertTextLeftLane_StringDataDW[53];/* '<S70>/Insert Text: Left Lane' */
  uint8_T InsertTextRightLane_RepBuf;  /* '<S70>/Insert Text: Right Lane' */
  uint8_T InsertTextRightLane_VarHolder;/* '<S70>/Insert Text: Right Lane' */
  uint8_T InsertTextRightLane_StringDataD[53];/* '<S70>/Insert Text: Right Lane' */
  uint8_T ForIterator_IterationMarker; /* '<S52>/For Iterator' */
  uint8_T ForIterator_IterationMarker_c;/* '<S56>/For Iterator' */
  uint8_T Iterator_IterationMarker[4]; /* '<S41>/Iterator' */
  boolean_T uDFIRFilter_isHgtUpd[2];   /* '<S3>/2-D FIR Filter' */
  boolean_T objisempty;                /* '<S66>/MATLAB System' */
  boolean_T LDLFactorization_STATE;    /* '<S48>/LDL Factorization' */
} DW_vipldws2_T;
...
struct P_vipldws2_T_ {
  ...
  uint8_T Rotate_fillVal;              /* Mask Parameter: Rotate_fillVal
                                        ...
                                        */
  uint8_T Rotate_fillVal_f;            /* Mask Parameter: Rotate_fillVal_f
 ...
 * Block '<S31>/Zero-Order Hold3' : Eliminated since input and output rates are identical
 * Block '<S31>/Zero-Order Hold4' : Eliminated since input and output rates are identical
 ...
 * Block '<S30>/Zero-Order Hold1' : Eliminated since input and output rates are identical
 * Block '<S30>/Zero-Order Hold2' : Eliminated since input and output rates are identical
 * Block '<S43>/P_Reshape' : Reshape block reduction
 ...
 * '<S26>'  : 'vipldws2/Input/MATLAB Function1'
 * '<S27>'  : 'vipldws2/Input/RGB to Image'
 * '<S28>'  : 'vipldws2/Lane Detection/3rd lane: Right-Left'
 * '<S29>'  : 'vipldws2/Lane Detection/Overwrite'
 * '<S30>'  : 'vipldws2/Lane Detection/Peak detection'
 * '<S31>'  : 'vipldws2/Lane Detection/3rd lane: Right-Left/Find Left 3rd Lane'
 * '<S32>'  : 'vipldws2/Lane Detection/3rd lane: Right-Left/Find Right 3rd Lane'
 * '<S33>'  : 'vipldws2/Lane Detection/Peak detection/Enable signal generator'
 * '<S34>'  : 'vipldws2/Lane Tracking/Kalman Filter'
 * '<S35>'  : 'vipldws2/Lane Tracking/Matching'
 * '<S36>'  : 'vipldws2/Lane Tracking/Only update the lines which  Kalman filter has been  trained for enough time'
 * '<S37>'  : 'vipldws2/Lane Tracking/Unit Delay Resettable'
 * '<S38>'  : 'vipldws2/Lane Tracking/Unit Delay Resettable1'
 * '<S39>'  : 'vipldws2/Lane Tracking/Update'
 * '<S40>'  : 'vipldws2/Lane Tracking/Kalman Filter/Check Signal Attributes'
 * '<S41>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control'
 * '<S42>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options'
 * '<S43>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Core'
 * '<S44>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/P_prd_Assign'
 * '<S45>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/X_prd_Assign'
 * '<S46>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Z_est_Assign'
 * '<S47>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Z_prd_Assign'
 * '<S48>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Core/LDL Solver'
 * '<S49>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Core/LDL Solver/Check Signal Attributes'
 * '<S50>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Core/LDL Solver/Check Signal Attributes1'
 * '<S51>'  : 'vipldws2/Lane Tracking/Kalman Filter/Control/Options/Core/LDL Solver/Check Signal Attributes2'
 * '<S52>'  : 'vipldws2/Lane Tracking/Matching/Calculate the distances between  the lines found in the current  frame and those in the repository'
 * '<S53>'  : 'vipldws2/Lane Tracking/Matching/Find the best  matches between the current  lines and those in the repository'
 * '<S54>'  : 'vipldws2/Lane Tracking/Matching/Update the repository'
 * '<S55>'  : 'vipldws2/Lane Tracking/Matching/Calculate the distances between  the lines found in the current  frame and those in the repository/Select a line from the repository; if it is valid (Count > 0),  Calculate its distance to the input lines.'
 * '<S56>'  : 'vipldws2/Lane Tracking/Matching/Calculate the distances between  the lines found in the current  frame and those in the repository/Select a line from the repository; if it is valid (Count > 0),  Calculate its distance to the input lines./Calculate the distances between  the chosen line in the repository  and all input lines.'
 ...
 * '<S58>'  : 'vipldws2/Lane Tracking/Matching/Find the best  matches between the current  lines and those in the repository/Compare To Constant'
 * '<S59>'  : 'vipldws2/Lane Tracking/Matching/Update the repository/Compare To Constant'
 * '<S60>'  : 'vipldws2/Lane Tracking/Matching/Update the repository/Compare To Constant1'
 * '<S61>'  : 'vipldws2/Lane Tracking/Matching/Update the repository/Compare To Zero'
 * '<S62>'  : 'vipldws2/Output/Compare To Constant1'
 * '<S63>'  : 'vipldws2/Output/Compare To Constant2'
 * '<S64>'  : 'vipldws2/Output/Draw  3rd Line'
 * '<S65>'  : 'vipldws2/Output/Exclude 3rd Lane'
 * '<S66>'  : 'vipldws2/Output/SDL Video Display'
 * '<S67>'  : 'vipldws2/Output/Subsystem'
 * '<S68>'  : 'vipldws2/Output/Subsystem1'
 * '<S69>'  : 'vipldws2/Output/Subsystem/Draw  Polygon'
 * '<S70>'  : 'vipldws2/Output/Subsystem/Draw Color and Marker Type'
 * '<S71>'  : 'vipldws2/Output/Subsystem/Signal From Workspace'
 * '<S72>'  : 'vipldws2/Output/Subsystem/Draw  Polygon/Line to Polygon Coordinates'
 */
